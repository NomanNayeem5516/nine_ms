...
class _HomeState extends State<Home> {
  ...
  Future<void> fetchFeaturedCategories() async {
    try {
      Categories categoryResponse = await Repository().getFeaturedCategories(); // Fetching categories
      setState(() {
  ...
  Future<void> fetchTodaysDealProducts() async {
    try {
      Products products = await Repository().getTodaysDealProducts(); // Fetching today's deal products
      setState(() {
          ...
          children: [
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Center(child: Text(category.name ?? "Unknown")),
                        )
            ...
            SizedBox(
              ...
              child: isLoadingProducts
                  ...
                  ? Center(child: Text("No today's deal products available"))
                  : ListView.builder(
                //scrollDirection: Axis.horizontal,
